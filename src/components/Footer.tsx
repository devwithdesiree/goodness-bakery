...
export default function Footer() {
  return (
   <footer className="bg-goodness-white pt-24 pb-12 border-t border-goodness-charcoal/10">
    <div className="h-[2px] w-14 bg-goodness-gold mx-auto mb-14 rounded-full"></div>
